...
import { flexColList } from './helper'
import WH from './WH.vue'

const dot = 'bg-white/50 size-1.3 rd-full'
  ...
  <div class="space-y-2">
    ...
    <div flex="~ gap-2">
      ...
      >
        ...
        >
          <div :class="item.icon" class="op-0 group-hover:op-100" />
          <div class="bg-white/50 size-1.3 rd-full op-100 group-hover:op-0 pos-center" />
        </div>
      </div>
      <div flex="1 ~ col gap-2">
        <Select v-model="selectedGap" placeholder="Gap" :options="gapList">
          <template #prefix>

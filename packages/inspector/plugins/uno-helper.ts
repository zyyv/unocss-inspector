    ...
    async writeBundle(options, bundle) {
      ...
      try {
        ...
        if (generatedCSS) {
          ...
          console.log('[@uno-inspect/inspector]: ✅ UnoCSS styles generated')
          console.log(`[@uno-inspect/inspector]: 📄 Scanned ${files.length} files`)
          console.log(`[@uno-inspect/inspector]: 🎨 Generated ${generatedCSS.split('\n').length} lines of CSS and ${matched.size} utilities`)
        }
      }
      catch (error) {

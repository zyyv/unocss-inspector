<!-- <template>
  <svg width="20" height="20" viewBox="0 0 220 220" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<template>
  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 16 16"><!-- Icon from Catppuccin Icons by Catppuccin - https://github.com/catppuccin/vscode-icons/blob/main/LICENSE --><g fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="#8087a2" d="M9 12a3 3 0 1 1 6 0a3 3 0 0 1-6 0" /><path stroke="#cad3f5" d="M7 12c0 1.75-1.25 3-3 3s-3-1.25-3-3V9h6zm2-8c0-1.75 1.25-3 3-3s3 1.25 3 3v3H9Z" /></g></svg>
</template>
